...
url = "https://huggingface.co/api/datasets/blog_authorship_corpus/parquet/blog_authorship_corpus/train/0.parquet"
...
const url = "https://huggingface.co/api/datasets/blog_authorship_corpus/parquet/blog_authorship_corpus/train/0.parquet"
```
</js>
</inferencesnippet>

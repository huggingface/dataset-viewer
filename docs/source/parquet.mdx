...
```json
{
  "ParaphraseRC": {
    "test": [
      "https://huggingface.co/datasets/duorc/resolve/refs%2Fconvert%2Fparquet/ParaphraseRC/duorc-test.parquet"
    ],
    "train": [
  ...
  "SelfRC": {
    "test": [
      "https://huggingface.co/datasets/duorc/resolve/refs%2Fconvert%2Fparquet/SelfRC/duorc-test.parquet"
    ],
    "train": [
      "https://huggingface.co/datasets/duorc/resolve/refs%2Fconvert%2Fparquet/SelfRC/duorc-train.parquet"
    ],
    "validation": [
...
You can get a single list by specifying the configuration name and split:

...
from libcommon.orchestrator import get_revison, remove_dataset, set_revision
...
def get_current_revison(
    dataset: str,
) -> Optional[str]:
    logging.debug(f"get current revison for dataset='{dataset}'")
    return get_revison(dataset=dataset)

...
PROCESSING_STEP_CONFIG_DUCKDB_INDEX_SIZE_VERSION = 1
...
PROCESSING_STEP_DATASET_DUCKDB_INDEX_SIZE_VERSION = 1
...
PROCESSING_STEP_SPLIT_DESCRIPTIVE_STATISTICS_VERSION = 3

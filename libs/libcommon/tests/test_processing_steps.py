...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("config-parquet", ["split-first-rows-from-parquet", "dataset-parquet"], ["/config-names", "config-parquet-and-info"]),
        ("dataset-parquet", [], ["/config-names", "config-parquet-and-info", "config-parquet"]),
        ("config-info", ["dataset-info", "/split-names-from-dataset-info"], ["/config-names", "config-parquet-and-info"]),

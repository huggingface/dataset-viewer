...
def test_default_graph() -> None:
    ...
    first_rows_from_streaming = graph.get_step("first-rows-from-streaming")
    ...
    assert split_names_from_streaming.children == [first_rows_from_streaming, dataset_split_names_from_streaming]
    ...
    assert first_rows_from_streaming is not None
    assert first_rows_from_streaming.parent is split_names_from_streaming
    assert first_rows_from_streaming.children == []
    assert first_rows_from_streaming.get_ancestors() == [config_names, split_names_from_streaming]
    ...
    assert graph.get_steps_required_by_dataset_viewer() == [splits, first_rows_from_streaming]

...
def get_CONFIG_STATE_DICT(dataset: str, config: str, split_states: List[Any], cache_exists: bool) -> Any:
    return {
        ...
        "artifact_states": [
            ...
            {
                "id": f"config-opt-in-out-urls-scan,{dataset},{config}",
                "job_state": {"is_in_process": False},
                "cache_state": {"exists": False, "is_success": False},
            },
        ],
...
def test_dataset_state_as_dict() -> None:
    ...
    assert dataset_state == {
        ...
        "artifact_states": [
            ...
            {
                "id": f"dataset-opt-in-out-urls-scan,{DATASET_NAME}",
                "job_state": {"is_in_process": False},
                "cache_state": {"exists": False, "is_success": False},
            },
        ],
    ...
    assert_dataset_state(
        ...
        cache_status={
            ...
            "cache_is_empty": [
                ...
                "dataset-opt-in-out-urls-scan,dataset",
        ...
        tasks=[
            ...
            "CreateJob[dataset-opt-in-out-urls-scan,dataset]",
    ...
    assert_dataset_state(
        ...
        cache_status={
            ...
            "cache_is_empty": [
                ...
                "config-opt-in-out-urls-scan,dataset,config1",
                "config-opt-in-out-urls-scan,dataset,config2",

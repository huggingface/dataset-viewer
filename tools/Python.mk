...
.PHONY: test
test:
	MONGO_PORT=${TEST_MONGO_PORT} COMPOSE_PROJECT_NAME=${TEST_COMPOSE_PROJECT_NAME} docker-compose -f $(TEST_DOCKER_COMPOSE) down -v --remove-orphans
	MONGO_PORT=${TEST_MONGO_PORT} COMPOSE_PROJECT_NAME=${TEST_COMPOSE_PROJECT_NAME} docker-compose -f $(TEST_DOCKER_COMPOSE) up -d
	...
	MONGO_PORT=${TEST_MONGO_PORT} COMPOSE_PROJECT_NAME=${TEST_COMPOSE_PROJECT_NAME} docker-compose -f $(TEST_DOCKER_COMPOSE) down -v

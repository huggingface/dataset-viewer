...
.PHONY: test-target
test-target:
	MONGO_URL=${TEST_MONGO_URL} MONGO_QUEUE_DATABASE=${TEST_MONGO_QUEUE_DATABASE} MONGO_CACHE_DATABASE=${TEST_MONGO_CACHE_DATABASE} ROWS_MAX_NUMBER=${TEST_ROWS_MAX_NUMBER} poetry run python -m pytest -x $(TEST_TARGET)

.PHONY: test-target-expression
test-target-expression:
	MONGO_URL=${TEST_MONGO_URL} MONGO_QUEUE_DATABASE=${TEST_MONGO_QUEUE_DATABASE} MONGO_CACHE_DATABASE=${TEST_MONGO_CACHE_DATABASE} ROWS_MAX_NUMBER=${TEST_ROWS_MAX_NUMBER} poetry run python -m pytest -x $(TEST_TARGET) -k $(TEST_EXPRESSION)

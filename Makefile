...
start-from-local-code:
	MONGO_PORT=${LOCAL_CODE_MONGO_PORT} ADMIN_UVICORN_PORT=${LOCAL_CODE_PORT_ADMIN} API_UVICORN_PORT=${LOCAL_CODE_PORT_API} PORT_REVERSE_PROXY=${LOCAL_CODE_PORT_REVERSE_PROXY} COMPOSE_PROJECT_NAME=${LOCAL_CODE_COMPOSE_PROJECT_NAME} DOCKER_COMPOSE=${LOCAL_CODE_DOCKER_COMPOSE} $(MAKE) down
	MONGO_PORT=${LOCAL_CODE_MONGO_PORT} ADMIN_UVICORN_PORT=${LOCAL_CODE_PORT_ADMIN} API_UVICORN_PORT=${LOCAL_CODE_PORT_API} PORT_REVERSE_PROXY=${LOCAL_CODE_PORT_REVERSE_PROXY} COMPOSE_PROJECT_NAME=${LOCAL_CODE_COMPOSE_PROJECT_NAME} DOCKER_COMPOSE=${LOCAL_CODE_DOCKER_COMPOSE} $(MAKE) up
...
start-from-remote-images:
	MONGO_PORT=${REMOTE_IMAGES_MONGO_PORT} ADMIN_UVICORN_PORT=${REMOTE_IMAGES_PORT_ADMIN} API_UVICORN_PORT=${REMOTE_IMAGES_PORT_API} PORT_REVERSE_PROXY=${REMOTE_IMAGES_PORT_REVERSE_PROXY} COMPOSE_PROJECT_NAME=${REMOTE_IMAGES_COMPOSE_PROJECT_NAME} DOCKER_COMPOSE=${REMOTE_IMAGES_DOCKER_COMPOSE} $(MAKE) down
	MONGO_PORT=${REMOTE_IMAGES_MONGO_PORT} ADMIN_UVICORN_PORT=${REMOTE_IMAGES_PORT_ADMIN} API_UVICORN_PORT=${REMOTE_IMAGES_PORT_API} PORT_REVERSE_PROXY=${REMOTE_IMAGES_PORT_REVERSE_PROXY} COMPOSE_PROJECT_NAME=${REMOTE_IMAGES_COMPOSE_PROJECT_NAME} DOCKER_COMPOSE=${REMOTE_IMAGES_DOCKER_COMPOSE} $(MAKE) up

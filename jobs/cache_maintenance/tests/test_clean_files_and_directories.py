...
def test_clean_files_and_directories(tmp_path_factory: TempPathFactory) -> None:
    hf_datasets_cache_directory = tmp_path_factory.mktemp("test_clean_files_and_directories") / "hf_datasets_cache"
    ...
    clean_files_and_directories(str(hf_datasets_cache_directory), expired_time_interval_seconds)
    assert cache_file.is_file()

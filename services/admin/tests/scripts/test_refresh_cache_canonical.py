...
def test_get_hf_canonical_dataset_names(app_config: AppConfig, hf_dataset_repos_csv_data: DatasetRepos) -> None:
    dataset_names = get_hf_canonical_dataset_names(hf_endpoint=app_config.common.hf_endpoint)

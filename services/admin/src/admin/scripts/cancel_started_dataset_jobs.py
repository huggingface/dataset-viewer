...
from libqueue.queue import cancel_started_dataset_jobs, connect_to_queue
...
if __name__ == "__main__":
    ...
    logger.info("all the started jobs in the datasets queue have been cancelled and re-enqueued")

...
def create_dataset_info_response_for_big_parquet() -> Any:
    return {
        ...
        "license": "",
        "features": BIG_cols,
        "splits": {"train": {"name": "train", "num_bytes": 5653946, "num_examples": len(BIG_rows), "dataset_name": None}},
...
def create_parquet_and_info_response(dataset: str, data_type: Literal["csv", "audio", "big"]) -> Any:
    dataset, config, split = get_default_config_split(dataset)
...
def hub_datasets(
    ...
    return {
        ...
        "big": {
            ...
            "parquet_and_info_response": create_parquet_and_info_response(dataset=hub_public_big, data_type="parquet"),
        },
        # "big-csv": {

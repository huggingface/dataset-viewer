...
def get_job_runner(
    ...
    def _get_job_runner(
        ...
        return DatasetOptInOutUrlsScanJobRunner(
            job_info={
                "type": DatasetOptInOutUrlsScanJobRunner.get_job_type(),
                "dataset": dataset,
                "config": None,
                "split": None,
                "job_id": "job_id",
            ...
            processing_step=ProcessingStep(
                name=DatasetOptInOutUrlsScanJobRunner.get_job_type(),
                input_type="config",
                requires=[],
                ...
                children=[],
                parents=[],
                job_runner_version=DatasetOptInOutUrlsScanJobRunner.get_job_runner_version(),
            ),
        )

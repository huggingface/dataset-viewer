...
@fixture
def stats_cache_directory(app_config: AppConfig) -> StrPath:
    return init_stats_cache_dir(app_config.descriptive_stats.cache_directory)
...
def set_env_vars(
    ...
    mp.setenv("DESCRIPTIVE_STATS_MAX_PARQUET_SIZE_BYTES", "10_000")

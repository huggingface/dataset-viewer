...
def compute_split_names_response(
    ...
    """
    Get the response of /split-names-streaming for one specific dataset and config on huggingface.co.
    ...
    The /split-names-streaming response generated by this function does not include stats about the split, like
    the size or number of samples. See /dataset-info or /sizes for that.

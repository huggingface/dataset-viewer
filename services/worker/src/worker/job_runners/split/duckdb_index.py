...
CREATE_TABLE_COMMAND = "CREATE OR REPLACE TABLE data AS SELECT {columns} FROM '{source}'; ALTER TABLE data ADD COLUMN __hf_index_id BIGINT DEFAULT nextval('serial');"

...
top_2k_most_liked_datasets = {
    ...
    "bigcode/starcoderdata", "microsoft/orca-math-word-problems-200k", "imagenet-1k", "nyu-mll/glue", "bigcode/the-stack-dedup", "togethercomputer/RedPajama-Data-V2", "gretelai/synthetic_text_to_sql", "allenai/objaverse", "Skylion007/openwebtext", "wikitext",
    ...
    "lambdalabs/pokemon-blip-captions", "shibing624/medical", "berkeley-nest/Nectar", "Intel/orca_dpo_pairs", "YeungNLP/firefly-train-1.1M", "BAAI/COIG-PC", "meta-math/MetaMathQA", "gsm8k", "codeparrot/github-code", "bookcorpus",
    "Open-Orca/SlimOrca", "dair-ai/emotion", "CohereForAI/aya_dataset", "c4", "cais/mmlu", "open-web-math/open-web-math", "code_search_net", "allenai/WildChat-1M", "rajpurkar/squad", "litagin/moe-speech",
    ...
    "TIGER-Lab/MathInstruct", "HuggingFaceH4/ultrafeedback_binarized", "PygmalionAI/PIPPA", "openai_humaneval", "cnn_dailymail", "yizhongw/self_instruct", "SirNeural/flan_v2", "nvidia/HelpSteer", "THUDM/AgentInstruct", "nvidia/OpenMathInstruct-1",
    ...
    "truthful_qa", "GAIR/MathPile", "Anthropic/persuasion", "m-a-p/Code-Feedback", "laion/laion2B-en", "wangrui6/Zhihu-KOL", "openchat/openchat_sharegpt4_dataset", "oscar", "sahil2801/CodeAlpaca-20k", "Tele-AI/TeleChat-PTD",
    "mozilla-foundation/common_voice_11_0", "mlabonne/orpo-dpo-mix-40k", "Open-Orca/FLAN", "rajpurkar/squad_v2", "nyanko7/LLaMA-65B", "super_glue", "cognitivecomputations/wizard_vicuna_70k_unfiltered", "Amod/mental_health_counseling_conversations", "EleutherAI/proof-pile-2", "ProGamerGov/StableDiffusion-v1-5-Regularization-Images",
    "the_pile_books3", "mc4", "knkarthick/dialogsum", "argilla/distilabel-capybara-dpo-7k-binarized", "nyanko7/danbooru2023", "Hello-SimpleAI/HC3-Chinese", "MMMU/MMMU", "ise-uiuc/Magicoder-Evol-Instruct-110K", "argilla/distilabel-intel-orca-dpo-pairs", "H-D-T/Buzz",
    ...
    "taesiri/arxiv_qa", "unalignment/toxic-dpo-v0.1", "math-ai/AutoMathText", "mozilla-foundation/common_voice_13_0", "nampdn-ai/tiny-textbooks", "ise-uiuc/Magicoder-OSS-Instruct-75K", "common_voice", "armanc/scientific_papers", "mlabonne/guanaco-llama2-1k", "DIBT/10k_prompts_ranked",
    ...
    "kakaobrain/coyo-700m", "gaia-benchmark/GAIA", "PleIAs/Post-OCR-Correction", "ag_news", "cognitivecomputations/WizardLM_alpaca_evol_instruct_70k_unfiltered", "BelleGroup/train_3.5M_CN", "togethercomputer/Long-Data-Collections", "derek-thomas/ScienceQA", "HuggingFaceM4/OBELICS", "abacusai/SystemChat",
    "google/MusicCaps", "dell-research-harvard/AmericanStories", "shahules786/orca-chat", "daily_dialog", "cognitivecomputations/samantha-data", "allenai/MADLAD-400", "pixparse/idl-wds", "eriktks/conll2003", "oscar-corpus/OSCAR-2201", "BelleGroup/multiturn_chat_0.8M",
    "knowrohit07/know_sql", "bigscience/xP3", "mosaicml/dolly_hhrlhf", "nvidia/ChatQA-Training-Data", "zzliang/GRIT", "tweet_eval", "togethercomputer/RedPajama-Data-1T-Sample", "izumi-lab/llm-japanese-dataset", "TigerResearch/pretrain_zh", "Dahoas/rm-static",
    ...
    "argilla/ultrafeedback-binarized-preferences-cleaned", "mbpp", "xlangai/spider", "Helsinki-NLP/opus-100", "openlifescienceai/medmcqa", "BelleGroup/train_0.5M_CN", "amazon_reviews_multi", "JeanKaddour/minipile", "michaelwzhu/ChatMed_Consult_Dataset", "MBZUAI/Bactrian-X",
    ...
    "kaist-ai/CoT-Collection", "allenai/objaverse-xl", "wikisql", "zeroshot/twitter-financial-news-sentiment", "mozilla-foundation/common_voice_17_0", "openbmb/UltraInteract_pair", "ms_marco", "wikiann", "xtreme", "osunlp/Mind2Web",
    ...
    "IlyaGusev/gpt_roleplay_realm", "cognitivecomputations/Dolphin-2.9", "allenai/sciq", "camel-ai/math", "liuhaotian/LLaVA-CC3M-Pretrain-595K", "silk-road/alpaca-data-gpt4-chinese", "facebook/belebele", "open-phi/textbooks", "SciPhi/AgentSearch-V1", "mnist",
    "yelp_review_full", "facebook/winoground", "lmsys/mt_bench_human_judgments", "shibing624/sharegpt_gpt4", "gbharti/finance-alpaca", "allenai/tulu-v2-sft-mixture", "andersonbcdefg/synthetic_retrieval_tasks", "Sao10K/Claude-3-Opus-Instruct-15K", "m-a-p/Matrix", "ncbi/pubmed",
    ...
    "shibing624/alpaca-zh", "THUDM/LongBench", "glaiveai/glaive-code-assistant", "keivalya/MedQuad-MedicalQnADataset", "arxiv_dataset", "nyu-mll/multi_nli", "kunishou/databricks-dolly-15k-ja", "lemonilia/LimaRP", "math_qa", "stanfordnlp/sst2",
    ...
    "ZenMoore/RoleBench", "speechcolab/gigaspeech", "neural-bridge/rag-dataset-12000", "amazon_us_reviews", "wikimedia/wikisource", "THUDM/humaneval-x", "liyucheng/zhihu_rlhf_3k", "PatronusAI/financebench", "EdinburghNLP/xsum", "unicamp-dl/mmarco",
    ...
    "jondurbin/gutenberg-dpo-v0.1", "PleIAs/French-PD-Newspapers", "blended_skill_talk", "mandarjoshi/trivia_qa", "visual_genome", "JanosAudran/financial-reports-sec", "fnlp/moss-003-sft-data", "approximatelabs/tablib-v1-full", "mozilla-foundation/common_voice_16_0", "xai-org/RealworldQA",
    "lmsys/lmsys-arena-human-preference-55k", "Abirate/english_quotes", "BelleGroup/generated_chat_0.4M", "maharshipandya/spotify-tracks-dataset", "TokenBender/code_instructions_122k_alpaca_style", "Flmc/DISC-Med-SFT", "ShengbinYue/DISC-Law-SFT", "argilla/ultrafeedback-binarized-preferences", "multi_news", "nguha/legalbench",
    "Squish42/bluemoon-fandom-1-1-rp-cleaned", "gorilla-llm/APIBench", "OpenAssistant/oasst_top1_2023-08-25", "joujiboi/japanese-anime-speech", "BAAI/CCI-Data", "conceptual_captions", "selfrag/selfrag_train_data", "MLCommons/peoples_speech", "laion/laion-coco", "gamino/wiki_medical_terms",
    ...
    "facebook/flores", "reazon-research/reazonspeech", "swype/instruct", "athirdpath/DPO_Pairs-Roleplay-Alpaca-NSFW", "cognitivecomputations/dolphin-coder", "McGill-NLP/WebLINX", "sarvamai/samvaad-hi-v1", "froggeric/creativity", "0-hero/Matter-0.1", "big_patent",
    "cc100", "jhu-clsp/jfleg", "neulab/conala", "jmhessel/newyorker_caption_contest", "HuggingFace-CN-community/translation", "bigcode/commitpack", "akoksal/LongForm", "JourneyDB/JourneyDB", "OpenGVLab/InternVid", "heliosbrahma/mental_health_chatbot_dataset",
    ...
    "eli5", "cimec/lambada", "PhilipMay/stsb_multi_mt", "GEM/wiki_lingua", "euirim/goodwiki", "laion/220k-GPT4Vision-captions-from-LIVIS", "sc890/DEEPFRUlT_DATASET", "Replete-AI/code_bagel", "cifar10", "medical_questions_pairs",
    "codeparrot/codeparrot-clean", "bigbench", "camel-ai/physics", "bigcode/commitpackft", "silk-road/ChatHaruhi-54K-Role-Playing-Dialogue", "clouditera/security-paper-datasets", "openerotica/freedom-rp", "Major-TOM/Core-S2L2A", "vblagoje/cc_news", "kilt_tasks",
    "pg19", "allenai/winogrande", "aharley/rvl_cdip", "naver-clova-ix/cord-v2", "jamescalam/unsplash-25k-photos", "jkhedri/psychology-dataset", "grammarly/coedit", "Duxiaoman-DI/FinCorpus", "a686d380/h-corpus-2023", "teknium/dataforge-economics",
    "jondurbin/cinematika-v0.1", "mlabonne/chatml_dpo_pairs", "hieunguyenminh/roleplay", "xz56/react-llama", "TeraflopAI/Caselaw_Access_Project", "coastalcph/lex_glue", "rotten_tomatoes", "yahoo_answers_topics", "miracl/miracl", "humarin/chatgpt-paraphrases",
    ...
    "hoskinson-center/proof-pile", "kaiokendev/SuperCOT-dataset", "tatsu-lab/alpaca_eval", "kwaikeg/KAgentInstruct", "MaziyarPanahi/WizardLM_evol_instruct_V2_196k", "xnli", "Muennighoff/flan", "qwedsacf/grade-school-math-instructions", "rickRossie/bluemoon_roleplay_chat_data_300k_messages", "codeparrot/self-instruct-starcoder",
    ...
    "LDJnr/Verified-Camel", "WenhaoWang/VidProM", "bigcode/the-stack-v2-dedup", "Cohere/wikipedia-2023-11-embed-multilingual-v3-int8-binary", "internlm/Agent-FLAN", "isidentical/moondream2-coyo-5M-captions", "fashion_mnist", "shibing624/nli_zh", "monash_tsf", "camel-ai/ai_society",
    ...
    "ncbi_disease", "wiki_lingua", "wikimedia/wit_base", "shunk031/JGLUE", "llm-wizard/alpaca-gpt4-data-zh", "Vision-CAIR/cc_sbu_align", "pharaouk/dharma-1", "jondurbin/airoboros-2.2.1", "Vezora/Tested-22k-Python-Alpaca", "HAERAE-HUB/KMMLU",
    "MMInstruction/ArxivCap", "jondurbin/py-dpo-v0.1", "PleIAs/French-PD-Books", "CohereForAI/aya_evaluation_suite", "CohereForAI/aya_collection_language_split", "ClusterlabAi/101_billion_arabic_words_dataset", "google/imageinwords", "amazon_polarity", "ehovy/race", "oscar-corpus/OSCAR-2109",
    ...
    "Trelis/function_calling_extended", "FreedomIntelligence/Evol-Instruct-Chinese-GPT4", "Anthropic/discrim-eval", "nlpie/Llama2-MedTuned-Instructions", "PixArt-alpha/SAM-LLaVA-Captions10M", "AkitoP/Hscene-Speech", "mlqa", "webis/tldr-17", "trec", "biglam/europeana_newspapers",
    ...
    "THUDM/LongAlign-10k", "LeoZhangzaolin/Graptoloidea-Specimens-Imaging", "ResplendentAI/NSFW_RP_Format_DPO", "RekaAI/VibeEval", "tomg-group-umd/cinepile", "banking77", "rmyeid/polyglot_ner", "tapaco", "deepset/germanquad", "laion/laion2B-multi",
    ...
    "cognitivecomputations/ultrachat-uncensored", "facebook/emu_edit_test_set", "playgroundai/MJHQ-30K", "zwn22/NC_Crime", "Shitao/MLDR", "Sayali9141/traffic_signal_images", "deutsche-telekom/Ger-RAG-eval", "billsum", "clue", "cuad",
    ...
    "conv_ai_2", "ccdv/govreport-summarization", "mozilla-foundation/common_voice_8_0", "nomic-ai/gpt4all_prompt_generations_with_p3", "hugfaceguy0001/retarded_bar", "lksy/ru_instruct_gpt4", "Linly-AI/Chinese-pretraining-dataset", "mosaicml/instruct-v3", "corbt/all-recipes", "VatsaDev/TinyText",
    "google/docci", "linux-cn/archive", "Johnnyeee/Yelpdata_663", "HuggingFaceTB/cosmopedia-100k", "nyu-mll/blimp", "bookcorpusopen", "iwslt2017", "recipe_nlg", "Helsinki-NLP/tatoeba", "GEM/viggo",
    ...
    "gwenxin/pills_inside_bottles", "keithito/lj_speech", "conll2012_ontonotesv5", "mwritescode/slither-audited-smart-contracts", "bsmock/pubtables-1m", "tasksource/mmlu", "bigcode/bigcode-pii-dataset", "medalpaca/medical_meadow_wikidoc", "P01son/instructions", "ArtifactAI/arxiv-physics-instruct-tune-30k",
    ...
    "gigaword", "wider_face", "wiki_qa", "HUPD/hupd", "liweili/c4_200m", "nielsr/funsd-layoutlmv3", "IDEA-CCNL/laion2B-multi-chinese-subset", "dennlinger/eur-lex-sum", "mitclinicalml/clinical-ie", "Matthijs/cmu-arctic-xvectors",
    ...
    "jondurbin/airoboros-3.2", "facebook/anli", "ibm/duorc", "gem", "peluz/lener_br", "Helsinki-NLP/news_commentary", "paws-x", "clips/mfaq", "skytnt/anime-segmentation", "alkzar90/NIH-Chest-X-ray-dataset",
    ...
    "hfl/ruozhiba_gpt4_turbo", "narrativeqa", "RussianNLP/russian_super_glue", "speech_commands", "karpathy/tiny_shakespeare", "wiki_dpr", "skt/kobest_v1", "laion/laion-art", "gigant/oldbookillustrations", "ontocord/OIG-moderation",
    ...
    "jondurbin/contextual-dpo-v0.1", "matlok/multimodal-python-copilot-training-overview", "bai-roleplay/evol-character-200", "cathw/reddit_climate_comment", "wenbopan/Chinese-dpo-pairs", "AI-Lab-Makerere/beans", "indonlp/indonlu", "coastalcph/multi_eurlex", "superb", "universal_dependencies",
    ...
    "CausalLM/GPT-4-Self-Instruct-German", "shareAI/novelai3", "MinervaAI/Aesir-Preview", "wintercoming6/artwork_for_sdxl", "Salesforce/lotsa_data", "ForzaJuve1/UEFA_Euro_2020_Data", "mo-mittal/reddit_political_subs", "Targoman/TLPC", "paws", "web_questions",
    ...
    "gvecchio/MatSynth", "baobab-trees/wikipedia-human-retrieval-ja", "mii-llm/gazzetta-ufficiale", "shachardon/ShareLM", "MohamedRashad/midjourney-detailed-prompts", "ade_corpus_v2", "cifar100", "mhardalov/exams", "josecannete/large_spanish_corpus", "quac",
    ...
    "ajibawa-2023/Code-290k-ShareGPT", "bai-roleplay/evol-character-entire", "minhanhto09/NuCLS_dataset", "cl-nagoya/auto-wiki-qa", "speechbrain/common_language", "sms_spam", "Babelscape/rebel-dataset", "cfilt/iitb-english-hindi", "gfissore/arxiv-abstracts-2021", "mozilla-foundation/common_voice_7_0",
    ...
    "Locutusque/hercules-v2.0", "HathawayLiu/housing_dataset", "bigcode/the-stack-v2-train-full-ids", "YXu120/NC_Education", "motherduckdb/duckdb-text2sql-25k", "Wenetspeech4TTS/WenetSpeech4TTS", "naklecha/minecraft-question-answer-700k", "HannahRoseKirk/prism-alignment", "arabic_speech_corpus", "allenai/common_gen",
    "health_fact", "multi_woz_v22", "yahoo_answers_qa", "MLCommons/ml_spoken_words", "ucberkeley-dlab/measuring-hate-speech", "bigscience/xP3mt", "sayakpaul/nyu_depth_v2", "argilla/medical-domain", "nlphuji/flickr30k", "aadityaubhat/GPT-wiki-intro",
    ...
    "visheratin/realworldqa", "lorinma/ChineseEncyclopedia", "app_reviews", "msra_ner", "openslr", "riddle_sense", "zhoubolei/scene_parse_150", "allenai/scitldr", "tydiqa", "IlyaGusev/gazeta",
    "albertvillanova/legal_contracts", "conceptual_12m", "textvqa", "VIMA/VIMA-Data", "hanamizuki-ai/genshin-voice-v3.3-mandarin", "Nerfgun3/sakimi-chan_LoRA", "cyberagent/crello", "jxm/the_office_lines", "WynterJones/chatgpt-roles", "gbharti/wealth-alpaca_lora",
    ...
    "osunlp/SMolInstruct", "allenai/WildBench", "FuseAI/FuseChat-Mixture", "Vezora/Tested-143k-Python-Alpaca", "cats_vs_dogs", "tdavidson/hate_speech_offensive", "snow_simplified_japanese_corpus", "timit_asr", "web_nlg", "wiki_bio",
    ...
    "fnlp/AnyInstruct", "NousResearch/json-mode-eval", "XintongHe/Stomatal_Images_Datasets", "abacusai/MetaMath_DPO_FewShot", "coseal/CodeUltraFeedback", "BAAI/CCI2-Data", "Astris/LA-Times", "H-D-T/RLSTACK", "aqua_rat", "arabic_billion_words",
    "google/code_x_glue_tc_text_to_code", "medal", "mt_eng_vietnamese", "quora", "vctk", "wmt/wmt19", "dalle-mini/YFCC100M_OpenAI_subset", "merve/poetry", "yhavinga/ccmatrix", "silver/personal_dialog",
    ...
    "cloneofsimo/imagenet.int8", "Replete-AI/code_bagel_hermes-2.5", "acronym_identification", "cornell_movie_dialog", "fancyzhx/dbpedia_14", "esnli", "fever", "google/jigsaw_toxicity_pred", "xquad", "NbAiLab/NCC",
    ...
    "rc9494/SP500_Date_Offset", "EleutherAI/lichess-puzzles", "conceptnet5", "cosmos_qa", "docred", "md_gender_bias", "mkqa", "onestop_english", "squad_kor_v1", "swag",
    "tweets_hate_speech_detection", "wmt/wmt16", "ChristophSchuhmann/MS_COCO_2017_URL_TEXT", "SetFit/emotion", "ai4bharat/samanantar", "ccdv/arxiv-classification", "mteb/tweet_sentiment_extraction", "beki/privy", "zoheb/sketch-scene", "WINGNUS/ACL-OCL",
    ...
    "Qdrant/dbpedia-entities-openai3-text-embedding-3-large-3072-1M", "mlabonne/chatml-OpenHermes2.5-dpo-binarized-alpha", "jg583/NSynth", "storytracer/LoC-PD-Books", "zhongshsh/CLoT-Oogiri-GO", "davidkim205/kollm-converations", "Locutusque/hercules-v4.0", "climate_fever", "cmrc2018", "mrqa",
    "nq_open", "kyunghyuncho/search_qa", "ted_talks_iwslt", "ubuntu_dialogs_corpus", "SetFit/enron_spam", "gsarti/flores_101", "vblagoje/lfqa", "huggan/pokemon", "joelniklaus/lextreme", "OxAISH-AL-LLM/wiki_toxic",
    ...
    "maywell/koVast", "unicamp-dl/quati", "YanweiLi/MGM-Instruction", "BLINK-Benchmark/BLINK", "abacusai/SystemChat-1.1", "DLI-Lab/pearl", "Vi-VLM/Vista", "crd3", "hate_speech18", "Helsinki-NLP/kde4",
    "kuznetsoffandrey/sberquad", "McGill-NLP/stereoset", "universal_morphologies", "wino_bias", "CAiRE/ASCEND", "huggingface/label-files", "laion/laion5B-index", "vicenteor/sbu_captions", "McGill-NLP/FaithDial", "LIUM/tedlium",
    ...
    "brwac", "conllpp", "covost2", "head_qa", "facebook/lama", "multi_x_science_sum", "ptb_text_only", "social_bias_frames", "sst", "the_pile_openwebtext2",
    "wiki40b", "wiki_atomic_edits", "botisan-ai/cantonese-mandarin-translations", "nlpaueb/finer-139", "wikitablequestions", "silver/lccc", "facebook/content_rephrasing", "Twitter/TwitterFollowGraph", "Nerfgun3/wlop_style", "TheFusion21/PokemonCards",
    ...
    "cassiekang/cub200_dataset", "antiven0m/catboros-3.2-dpo", "ai4privacy/pii-masking-300k", "multilingual/orca_dpo_pairs", "BigAction/the-wave-clean", "ami", "TheBritishLibrary/blbooks", "conv_ai_3", "e2e_nlg", "ethos",
    "Helsinki-NLP/europarl", "hkcancor", "ucsbnlp/liar", "newsqa", "sem_eval_2018_task_1", "rcds/swiss_judgment_prediction", "told-br", "leondz/wnut_17", "CodedotAI/code_clippy_github", "castorini/mr-tydi",
    ...
    "kigner/ruozhiba-llama3-tt", "H-D-T/Select-Stack", "alt", "ar_sarcasm", "assin2", "cbt", "eurlex", "facebook/kilt_wikipedia", "multilingual_librispeech", "reuters21578",
    "sentiment140", "squad_es", "the_pile_stack_exchange", "wiki_movies", "Fraser/python-state-changes", "Hellisotherpeople/DebateSum", "SocialGrep/one-million-reddit-jokes", "blinoff/medical_qa_ru_data", "huggingface/transformers-metadata", "indonesian-nlp/id_newspapers_2018",
    "openclimatefix/nimrod-uk-1km", "sentence-transformers/msmarco-hard-negatives", "nthngdy/oscar-small", "jiangjiechen/ekar_chinese", "sil-ai/bloom-captioning", "orieg/elsevier-oa-cc-by", "imagenet_sketch", "sileod/movie_recommendation", "quickdraw", "huggingface-legal/takedown-notices",
    ...
    "aeslc", "aquamuse", "allenai/atomic", "consumer-finance-complaints", "cppe-5", "craigslist_bargains", "fquad", "google_wellformed_query", "interpress_news_category_tr_lite", "thu-coai/kd_conv_with_kb",
    "kakaobrain/kor_nli", "para_pat", "poem_sentiment", "silicone", "story_cloze", "turkic_xwmt", "wi_locness", "fancyzhx/yelp_polarity", "CodedotAI/code_clippy", "SetFit/sst5",
    ...
    "kigner/ruozhiba-llama3", "davanstrien/dataset-tldr-preference-dpo", "facebook/asset", "blog_authorship_corpus", "c3", "clinc_oos", "eli5_category", "mohnish/lc_quad", "lm1b", "para_crawl",
    "spanish_billion_words", "squad_kor_v2", "squad_v1_pt", "swda", "thaisum", "wmt/wmt14", "SetFit/20_newsgroups", "bertin-project/mc4-sampling", "lbox/lbox_open", "codeparrot/codeparrot-clean-train",

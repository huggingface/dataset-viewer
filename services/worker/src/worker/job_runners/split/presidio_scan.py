...
top_2k_most_liked_datasets = {
    ...
    "bigcode/starcoderdata", "microsoft/orca-math-word-problems-200k", "ILSVRC/imagenet-1k", "nyu-mll/glue", "bigcode/the-stack-dedup", "togethercomputer/RedPajama-Data-V2", "gretelai/synthetic_text_to_sql", "allenai/objaverse", "Skylion007/openwebtext", "Salesforce/wikitext",
    ...
    "lambdalabs/pokemon-blip-captions", "shibing624/medical", "berkeley-nest/Nectar", "Intel/orca_dpo_pairs", "YeungNLP/firefly-train-1.1M", "BAAI/COIG-PC", "meta-math/MetaMathQA", "openai/gsm8k", "codeparrot/github-code", "bookcorpus/bookcorpus",
    ...
    "openai/summarize_from_feedback", "nickrosh/Evol-Instruct-Code-80k-v1", "storytracer/US-PD-Books", "OpenAssistant/oasst2", "Cohere/wikipedia-2023-11-embed-multilingual-v3", "argilla/OpenHermesPreferences", "Hello-SimpleAI/HC3", "SciPhi/textbooks-are-all-you-need-lite", "vikp/textbook_quality_programming", "takala/financial_phrasebank",
    ...
    "defunct-datasets/the_pile_books3", "legacy-datasets/mc4", "knkarthick/dialogsum", "argilla/distilabel-capybara-dpo-7k-binarized", "nyanko7/danbooru2023", "Hello-SimpleAI/HC3-Chinese", "MMMU/MMMU", "ise-uiuc/Magicoder-Evol-Instruct-110K", "argilla/distilabel-intel-orca-dpo-pairs", "H-D-T/Buzz",
    ...
    "UCSD26/medical_dialog", "nomic-ai/gpt4all_prompt_generations", "google-research-datasets/go_emotions", "iamtarun/python_code_instructions_18k_alpaca", "argilla/dpo-mix-7k", "MBZUAI/LaMini-instruction", "qiaojin/PubMedQA", "LinkSoul/instruction_merge_set", "LooksJuicy/ruozhiba", "pleisto/wikipedia-cn-20230720-filtered",
    ...
    "HuggingFaceH4/stack-exchange-preferences", "hakurei/open-instruct-v1", "liuhaotian/LLaVA-Pretrain", "MMInstruction/M3IT", "lmsys/toxic-chat", "openslr/librispeech_asr", "codeparrot/apps", "BelleGroup/train_2M_CN", "laion/gpt4v-dataset", "jondurbin/truthy-dpo-v0.1",
    "argilla/ultrafeedback-binarized-preferences-cleaned", "google-research-datasets/mbpp", "xlangai/spider", "Helsinki-NLP/opus-100", "openlifescienceai/medmcqa", "BelleGroup/train_0.5M_CN", "defunct-datasets/amazon_reviews_multi", "JeanKaddour/minipile", "michaelwzhu/ChatMed_Consult_Dataset", "MBZUAI/Bactrian-X",
    ...
    "yys/OpenOrca-Chinese", "unalignment/toxic-dpo-v0.2", "nampdn-ai/tiny-strange-textbooks", "facebook/empathetic_dialogues", "philschmid/sharegpt-raw", "X2FD/LVIS-Instruct4V", "deepmind/math_dataset", "sunzeyeah/chinese_chatgpt_corpus", "wanng/midjourney-v5-202304-clean", "ybisk/piqa",
    ...
    "shibing624/alpaca-zh", "THUDM/LongBench", "glaiveai/glaive-code-assistant", "keivalya/MedQuad-MedicalQnADataset", "arxiv-community/arxiv_dataset", "nyu-mll/multi_nli", "kunishou/databricks-dolly-15k-ja", "lemonilia/LimaRP", "allenai/math_qa", "stanfordnlp/sst2",
    ...
    "0xJustin/Dungeons-and-Diffusion", "tiange/Cap3D", "NumbersStation/NSText2SQL", "b3x0m/Chinese-H-Novels", "hotpotqa/hotpot_qa", "YeungNLP/moss-003-sft-data", "osunlp/MagicBrush", "Yukang/LongAlpaca-12k", "math-ai/StackMathQA", "PolyAI/minds14",
    ...
    "Cohere/wikipedia-22-12-simple-embeddings", "lukaemon/mmlu", "bigcode/humanevalpack", "ArtifactAI/arxiv-math-instruct-50k", "dikw/hh_rlhf_cn", "ethz/food101", "allenai/qasper", "stanfordnlp/snli", "Helsinki-NLP/tatoeba_mt", "laion/laion-high-resolution",
    ...
    "reciTAL/mlsum", "google/xtreme_s", "Linaqruf/pixiv-niji-journey", "THUDM/webglm-qa", "starmpcc/Asclepius-Synthetic-Clinical-Notes", "fondant-ai/fondant-cc-25m", "jondurbin/airoboros-3.1", "wenge-research/yayi2_pretrain_data", "TuringsSolutions/NYTWritingStyleGuide", "KBlueLeaf/danbooru2023-sqlite",
    ...
    "defunct-datasets/eli5", "cimec/lambada", "PhilipMay/stsb_multi_mt", "GEM/wiki_lingua", "euirim/goodwiki", "laion/220k-GPT4Vision-captions-from-LIVIS", "sc890/DEEPFRUlT_DATASET", "Replete-AI/code_bagel", "uoft-cs/cifar10", "curaihealth/medical_questions_pairs",
    "codeparrot/codeparrot-clean", "google/bigbench", "camel-ai/physics", "bigcode/commitpackft", "silk-road/ChatHaruhi-54K-Role-Playing-Dialogue", "clouditera/security-paper-datasets", "openerotica/freedom-rp", "Major-TOM/Core-S2L2A", "vblagoje/cc_news", "facebook/kilt_tasks",
    ...
    "LDJnr/Verified-Camel", "WenhaoWang/VidProM", "bigcode/the-stack-v2-dedup", "Cohere/wikipedia-2023-11-embed-multilingual-v3-int8-binary", "internlm/Agent-FLAN", "isidentical/moondream2-coyo-5M-captions", "zalando-datasets/fashion_mnist", "shibing624/nli_zh", "Monash-University/monash_tsf", "camel-ai/ai_society",
    ...
    "toxigen/toxigen-data", "joelniklaus/Multi_Legal_Pile", "miracl/miracl-corpus", "alespalla/chatbot_instruction_prompts", "teknium/GPTeacher-General-Instruct", "jondurbin/airoboros-gpt4-1.4.1", "VMware/open-instruct", "allenai/reward-bench", "davanstrien/haiku_dpo", "klue/klue",
    ...
    "Trelis/function_calling_extended", "FreedomIntelligence/Evol-Instruct-Chinese-GPT4", "Anthropic/discrim-eval", "nlpie/Llama2-MedTuned-Instructions", "PixArt-alpha/SAM-LLaVA-Captions10M", "AkitoP/Hscene-Speech", "facebook/mlqa", "webis/tldr-17", "CogComp/trec", "biglam/europeana_newspapers",
    ...
    "google/docci", "linux-cn/archive", "Johnnyeee/Yelpdata_663", "HuggingFaceTB/cosmopedia-100k", "nyu-mll/blimp", "defunct-datasets/bookcorpusopen", "IWSLT/iwslt2017", "mbien/recipe_nlg", "Helsinki-NLP/tatoeba", "GEM/viggo",
    ...
    "Harvard/gigaword", "CUHK-CSE/wider_face", "microsoft/wiki_qa", "HUPD/hupd", "liweili/c4_200m", "nielsr/funsd-layoutlmv3", "IDEA-CCNL/laion2B-multi-chinese-subset", "dennlinger/eur-lex-sum", "mitclinicalml/clinical-ie", "Matthijs/cmu-arctic-xvectors",
    ...
    "jondurbin/airoboros-3.2", "facebook/anli", "ibm/duorc", "GEM/gem", "peluz/lener_br", "Helsinki-NLP/news_commentary", "google-research-datasets/paws-x", "clips/mfaq", "skytnt/anime-segmentation", "alkzar90/NIH-Chest-X-ray-dataset",
    ...
    "ImperialCollegeLondon/health_fact", "pfb30/multi_woz_v22", "nfL6/yahoo_answers_qa", "MLCommons/ml_spoken_words", "ucberkeley-dlab/measuring-hate-speech", "bigscience/xP3mt", "sayakpaul/nyu_depth_v2", "argilla/medical-domain", "nlphuji/flickr30k", "aadityaubhat/GPT-wiki-intro",
    ...
    "google/code_x_glue_tc_text_to_code", "McGill-NLP/medal", "IWSLT/mt_eng_vietnamese", "quora-competitions/quora", "CSTR-Edinburgh/vctk", "wmt/wmt19", "dalle-mini/YFCC100M_OpenAI_subset", "merve/poetry", "yhavinga/ccmatrix", "silver/personal_dialog",
    ...
    "cloneofsimo/imagenet.int8", "Replete-AI/code_bagel_hermes-2.5", "amirveyseh/acronym_identification", "cornell-movie-dialog/cornell_movie_dialog", "fancyzhx/dbpedia_14", "esnli/esnli", "fever/fever", "google/jigsaw_toxicity_pred", "google/xquad", "NbAiLab/NCC",
    ...
    "rc9494/SP500_Date_Offset", "EleutherAI/lichess-puzzles", "conceptnet5/conceptnet5", "allenai/cosmos_qa", "thunlp/docred", "facebook/md_gender_bias", "apple/mkqa", "iastate/onestop_english", "KorQuAD/squad_kor_v1", "allenai/swag",
    ...
    "maywell/koVast", "unicamp-dl/quati", "YanweiLi/MGM-Instruction", "BLINK-Benchmark/BLINK", "abacusai/SystemChat-1.1", "DLI-Lab/pearl", "Vi-VLM/Vista", "microsoft/crd3", "odegiber/hate_speech18", "Helsinki-NLP/kde4",
    ...
    "UFRGS/brwac", "ZihanWangKi/conllpp", "facebook/covost2", "dvilares/head_qa", "facebook/lama", "yaolu/multi_x_science_sum", "ptb-text-only/ptb_text_only", "allenai/social_bias_frames", "stanfordnlp/sst", "defunct-datasets/the_pile_openwebtext2",
    ...
    "cassiekang/cub200_dataset", "antiven0m/catboros-3.2-dpo", "ai4privacy/pii-masking-300k", "multilingual/orca_dpo_pairs", "BigAction/the-wave-clean", "legacy-datasets/ami", "TheBritishLibrary/blbooks", "convai-challenge/conv_ai_3", "tuetschek/e2e_nlg", "iamollas/ethos",
    "Helsinki-NLP/europarl", "nanyang-technological-university-singapore/hkcancor", "ucsbnlp/liar", "Maluuba/newsqa", "SemEvalWorkshop/sem_eval_2018_task_1", "rcds/swiss_judgment_prediction", "JAugusto97/told-br", "leondz/wnut_17", "CodedotAI/code_clippy_github", "castorini/mr-tydi",
    ...
    "kigner/ruozhiba-llama3-tt", "H-D-T/Select-Stack", "mutiyama/alt", "iabufarha/ar_sarcasm", "nilc-nlp/assin2", "cam-cst/cbt", "NLP-AUEB/eurlex", "facebook/kilt_wikipedia", "legacy-datasets/multilingual_librispeech", "ucirvine/reuters21578",
    ...
    "openclimatefix/nimrod-uk-1km", "sentence-transformers/msmarco-hard-negatives", "nthngdy/oscar-small", "jiangjiechen/ekar_chinese", "sil-ai/bloom-captioning", "orieg/elsevier-oa-cc-by", "songweig/imagenet_sketch", "sileod/movie_recommendation", "google/quickdraw", "huggingface-legal/takedown-notices",
    ...
    "Yale-LILY/aeslc", "google-research-datasets/aquamuse", "allenai/atomic", "CFPB/consumer-finance-complaints", "rishitdagli/cppe-5", "stanfordnlp/craigslist_bargains", "illuin/fquad", "google-research-datasets/google_wellformed_query", "yavuzkomecoglu/interpress_news_category_tr_lite", "thu-coai/kd_conv_with_kb",
    ...
    "kigner/ruozhiba-llama3", "davanstrien/dataset-tldr-preference-dpo", "facebook/asset", "barilan/blog_authorship_corpus", "dataset-org/c3", "clinc/clinc_oos", "rexarski/eli5_category", "mohnish/lc_quad", "billion-word-benchmark/lm1b", "ParaCrawl/para_crawl",

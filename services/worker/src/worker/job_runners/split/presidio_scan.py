...
top_2k_most_liked_datasets = {
    ...
    "truthfulqa/truthful_qa", "GAIR/MathPile", "Anthropic/persuasion", "m-a-p/Code-Feedback", "laion/laion2B-en", "wangrui6/Zhihu-KOL", "openchat/openchat_sharegpt4_dataset", "oscar", "sahil2801/CodeAlpaca-20k", "Tele-AI/TeleChat-PTD",
    ...
    "kaist-ai/CoT-Collection", "allenai/objaverse-xl", "Salesforce/wikisql", "zeroshot/twitter-financial-news-sentiment", "mozilla-foundation/common_voice_17_0", "openbmb/UltraInteract_pair", "ms_marco", "unimelb-nlp/wikiann", "google/xtreme", "osunlp/Mind2Web",
    ...
    "jondurbin/cinematika-v0.1", "mlabonne/chatml_dpo_pairs", "hieunguyenminh/roleplay", "xz56/react-llama", "TeraflopAI/Caselaw_Access_Project", "coastalcph/lex_glue", "rotten_tomatoes", "community-datasets/yahoo_answers_topics", "miracl/miracl", "humarin/chatgpt-paraphrases",
    ...
    "ncbi_disease", "esdurmus/wiki_lingua", "wikimedia/wit_base", "shunk031/JGLUE", "llm-wizard/alpaca-gpt4-data-zh", "Vision-CAIR/cc_sbu_align", "pharaouk/dharma-1", "jondurbin/airoboros-2.2.1", "Vezora/Tested-22k-Python-Alpaca", "HAERAE-HUB/KMMLU",
    ...
    "hfl/ruozhiba_gpt4_turbo", "narrativeqa", "RussianNLP/russian_super_glue", "speech_commands", "karpathy/tiny_shakespeare", "facebook/wiki_dpr", "skt/kobest_v1", "laion/laion-art", "gigant/oldbookillustrations", "ontocord/OIG-moderation",
    ...
    "jondurbin/contextual-dpo-v0.1", "matlok/multimodal-python-copilot-training-overview", "bai-roleplay/evol-character-200", "cathw/reddit_climate_comment", "wenbopan/Chinese-dpo-pairs", "AI-Lab-Makerere/beans", "indonlp/indonlu", "coastalcph/multi_eurlex", "superb", "universal-dependencies/universal_dependencies",
    ...
    "CausalLM/GPT-4-Self-Instruct-German", "shareAI/novelai3", "MinervaAI/Aesir-Preview", "wintercoming6/artwork_for_sdxl", "Salesforce/lotsa_data", "ForzaJuve1/UEFA_Euro_2020_Data", "mo-mittal/reddit_political_subs", "Targoman/TLPC", "paws", "Stanford/web_questions",
    ...
    "health_fact", "multi_woz_v22", "nfL6/yahoo_answers_qa", "MLCommons/ml_spoken_words", "ucberkeley-dlab/measuring-hate-speech", "bigscience/xP3mt", "sayakpaul/nyu_depth_v2", "argilla/medical-domain", "nlphuji/flickr30k", "aadityaubhat/GPT-wiki-intro",
    ...
    "visheratin/realworldqa", "lorinma/ChineseEncyclopedia", "sealuzh/app_reviews", "msra_ner", "openslr", "riddle_sense", "zhoubolei/scene_parse_150", "allenai/scitldr", "google-research-datasets/tydiqa", "IlyaGusev/gazeta",
    ...
    "osunlp/SMolInstruct", "allenai/WildBench", "FuseAI/FuseChat-Mixture", "Vezora/Tested-143k-Python-Alpaca", "microsoft/cats_vs_dogs", "tdavidson/hate_speech_offensive", "snow_simplified_japanese_corpus", "timit-asr/timit_asr", "webnlg-challenge/web_nlg", "michaelauli/wiki_bio",
    ...
    "google/code_x_glue_tc_text_to_code", "medal", "mt_eng_vietnamese", "quora", "CSTR-Edinburgh/vctk", "wmt/wmt19", "dalle-mini/YFCC100M_OpenAI_subset", "merve/poetry", "yhavinga/ccmatrix", "silver/personal_dialog",
    ...
    "nq_open", "kyunghyuncho/search_qa", "ted_talks_iwslt", "ubuntu-dialogs-corpus/ubuntu_dialogs_corpus", "SetFit/enron_spam", "gsarti/flores_101", "vblagoje/lfqa", "huggan/pokemon", "joelniklaus/lextreme", "OxAISH-AL-LLM/wiki_toxic",
    ...
    "Helsinki-NLP/europarl", "hkcancor", "ucsbnlp/liar", "newsqa", "sem_eval_2018_task_1", "rcds/swiss_judgment_prediction", "JAugusto97/told-br", "leondz/wnut_17", "CodedotAI/code_clippy_github", "castorini/mr-tydi",
    ...
    "sentiment140", "squad_es", "the_pile_stack_exchange", "facebook/wiki_movies", "Fraser/python-state-changes", "Hellisotherpeople/DebateSum", "SocialGrep/one-million-reddit-jokes", "blinoff/medical_qa_ru_data", "huggingface/transformers-metadata", "indonesian-nlp/id_newspapers_2018",
    ...
    "kakaobrain/kor_nli", "para_pat", "poem_sentiment", "silicone", "story_cloze", "turkic-interlingua/turkic_xwmt", "bea2019st/wi_locness", "fancyzhx/yelp_polarity", "CodedotAI/code_clippy", "SetFit/sst5",

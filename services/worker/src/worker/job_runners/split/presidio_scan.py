...
top_2k_most_liked_datasets = {
    ...
    "hfl/ruozhiba_gpt4_turbo", "narrativeqa", "RussianNLP/russian_super_glue", "google/speech_commands", "karpathy/tiny_shakespeare", "facebook/wiki_dpr", "skt/kobest_v1", "laion/laion-art", "gigant/oldbookillustrations", "ontocord/OIG-moderation",
    ...
    "rc9494/SP500_Date_Offset", "EleutherAI/lichess-puzzles", "conceptnet5/conceptnet5", "allenai/cosmos_qa", "thunlp/docred", "md_gender_bias", "mkqa", "onestop_english", "KorQuAD/squad_kor_v1", "allenai/swag",
    ...
    "nq_open", "kyunghyuncho/search_qa", "IWSLT/ted_talks_iwslt", "ubuntu-dialogs-corpus/ubuntu_dialogs_corpus", "SetFit/enron_spam", "gsarti/flores_101", "vblagoje/lfqa", "huggan/pokemon", "joelniklaus/lextreme", "OxAISH-AL-LLM/wiki_toxic",
    ...
    "UFRGS/brwac", "ZihanWangKi/conllpp", "facebook/covost2", "head_qa", "facebook/lama", "multi_x_science_sum", "ptb_text_only", "allenai/social_bias_frames", "stanfordnlp/sst", "defunct-datasets/the_pile_openwebtext2",
    ...
    "Helsinki-NLP/europarl", "hkcancor", "ucsbnlp/liar", "newsqa", "SemEvalWorkshop/sem_eval_2018_task_1", "rcds/swiss_judgment_prediction", "JAugusto97/told-br", "leondz/wnut_17", "CodedotAI/code_clippy_github", "castorini/mr-tydi",
    ...
    "kakaobrain/kor_nli", "para_pat", "poem_sentiment", "eusip/silicone", "LSDSem/story_cloze", "turkic-interlingua/turkic_xwmt", "bea2019st/wi_locness", "fancyzhx/yelp_polarity", "CodedotAI/code_clippy", "SetFit/sst5",

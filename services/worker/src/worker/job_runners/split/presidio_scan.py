...
top_2k_most_liked_datasets = {
    ...
    "TIGER-Lab/MathInstruct", "HuggingFaceH4/ultrafeedback_binarized", "PygmalionAI/PIPPA", "openai_humaneval", "abisee/cnn_dailymail", "yizhongw/self_instruct", "SirNeural/flan_v2", "nvidia/HelpSteer", "THUDM/AgentInstruct", "nvidia/OpenMathInstruct-1",
    ...
    "gvecchio/MatSynth", "baobab-trees/wikipedia-human-retrieval-ja", "mii-llm/gazzetta-ufficiale", "shachardon/ShareLM", "MohamedRashad/midjourney-detailed-prompts", "ade-benchmark-corpus/ade_corpus_v2", "uoft-cs/cifar100", "mhardalov/exams", "josecannete/large_spanish_corpus", "quac",
    ...
    "albertvillanova/legal_contracts", "google-research-datasets/conceptual_12m", "textvqa", "VIMA/VIMA-Data", "hanamizuki-ai/genshin-voice-v3.3-mandarin", "Nerfgun3/sakimi-chan_LoRA", "cyberagent/crello", "jxm/the_office_lines", "WynterJones/chatgpt-roles", "gbharti/wealth-alpaca_lora",
    ...
    "osunlp/SMolInstruct", "allenai/WildBench", "FuseAI/FuseChat-Mixture", "Vezora/Tested-143k-Python-Alpaca", "microsoft/cats_vs_dogs", "tdavidson/hate_speech_offensive", "snow_simplified_japanese_corpus", "timit_asr", "web_nlg", "wiki_bio",
    ...
    "cloneofsimo/imagenet.int8", "Replete-AI/code_bagel_hermes-2.5", "amirveyseh/acronym_identification", "cornell-movie-dialog/cornell_movie_dialog", "fancyzhx/dbpedia_14", "esnli", "fever", "google/jigsaw_toxicity_pred", "xquad", "NbAiLab/NCC",
    ...
    "rc9494/SP500_Date_Offset", "EleutherAI/lichess-puzzles", "conceptnet5/conceptnet5", "allenai/cosmos_qa", "thunlp/docred", "md_gender_bias", "mkqa", "onestop_english", "squad_kor_v1", "swag",
    ...
    "Qdrant/dbpedia-entities-openai3-text-embedding-3-large-3072-1M", "mlabonne/chatml-OpenHermes2.5-dpo-binarized-alpha", "jg583/NSynth", "storytracer/LoC-PD-Books", "zhongshsh/CLoT-Oogiri-GO", "davidkim205/kollm-converations", "Locutusque/hercules-v4.0", "tdiggelm/climate_fever", "hfl/cmrc2018", "mrqa",
    ...
    "UFRGS/brwac", "ZihanWangKi/conllpp", "facebook/covost2", "head_qa", "facebook/lama", "multi_x_science_sum", "ptb_text_only", "social_bias_frames", "sst", "the_pile_openwebtext2",
    ...
    "kigner/ruozhiba-llama3-tt", "H-D-T/Select-Stack", "mutiyama/alt", "iabufarha/ar_sarcasm", "nilc-nlp/assin2", "cam-cst/cbt", "eurlex", "facebook/kilt_wikipedia", "multilingual_librispeech", "reuters21578",
    ...
    "kigner/ruozhiba-llama3", "davanstrien/dataset-tldr-preference-dpo", "facebook/asset", "barilan/blog_authorship_corpus", "dataset-org/c3", "clinc/clinc_oos", "eli5_category", "mohnish/lc_quad", "lm1b", "para_crawl",

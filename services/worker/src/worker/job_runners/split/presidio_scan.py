...
top_2k_most_liked_datasets = {
    ...
    "jondurbin/gutenberg-dpo-v0.1", "PleIAs/French-PD-Newspapers", "ParlAI/blended_skill_talk", "mandarjoshi/trivia_qa", "visual_genome", "JanosAudran/financial-reports-sec", "fnlp/moss-003-sft-data", "approximatelabs/tablib-v1-full", "mozilla-foundation/common_voice_16_0", "xai-org/RealworldQA",
    ...
    "THUDM/LongAlign-10k", "LeoZhangzaolin/Graptoloidea-Specimens-Imaging", "ResplendentAI/NSFW_RP_Format_DPO", "RekaAI/VibeEval", "tomg-group-umd/cinepile", "legacy-datasets/banking77", "rmyeid/polyglot_ner", "tapaco", "deepset/germanquad", "laion/laion2B-multi",
    ...
    "cognitivecomputations/ultrachat-uncensored", "facebook/emu_edit_test_set", "playgroundai/MJHQ-30K", "zwn22/NC_Crime", "Shitao/MLDR", "Sayali9141/traffic_signal_images", "deutsche-telekom/Ger-RAG-eval", "FiscalNote/billsum", "clue", "cuad",
    ...
    "visheratin/realworldqa", "lorinma/ChineseEncyclopedia", "sealuzh/app_reviews", "msra_ner", "openslr", "riddle_sense", "zhoubolei/scene_parse_150", "allenai/scitldr", "tydiqa", "IlyaGusev/gazeta",
    ...
    "cassiekang/cub200_dataset", "antiven0m/catboros-3.2-dpo", "ai4privacy/pii-masking-300k", "multilingual/orca_dpo_pairs", "BigAction/the-wave-clean", "legacy-datasets/ami", "TheBritishLibrary/blbooks", "conv_ai_3", "e2e_nlg", "ethos",
    ...
    "kigner/ruozhiba-llama3-tt", "H-D-T/Select-Stack", "mutiyama/alt", "iabufarha/ar_sarcasm", "nilc-nlp/assin2", "cbt", "eurlex", "facebook/kilt_wikipedia", "multilingual_librispeech", "reuters21578",
    ...
    "Yale-LILY/aeslc", "google-research-datasets/aquamuse", "allenai/atomic", "consumer-finance-complaints", "cppe-5", "craigslist_bargains", "fquad", "google_wellformed_query", "interpress_news_category_tr_lite", "thu-coai/kd_conv_with_kb",
    ...
    "kigner/ruozhiba-llama3", "davanstrien/dataset-tldr-preference-dpo", "facebook/asset", "barilan/blog_authorship_corpus", "c3", "clinc_oos", "eli5_category", "mohnish/lc_quad", "lm1b", "para_crawl",

DEFAULT_API_HOSTNAME: str = "localhost"
DEFAULT_API_NUM_WORKERS: int = 2
...
DEFAULT_METRICS_HOSTNAME: str = "localhost"
DEFAULT_METRICS_NUM_WORKERS: int = 1
DEFAULT_METRICS_PORT: int = 8001

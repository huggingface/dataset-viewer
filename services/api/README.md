...
- `API_HF_AUTH_BYPASS_KEY`: the key to use to bypass the external authentication service. If not set (empty string), the authentication check cannot be bypassed. Defaults to `""`.
